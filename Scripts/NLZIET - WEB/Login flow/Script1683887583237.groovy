...
WebUI.verifyElementText(findTestObject('Object Repository/Page_NLZIET/h1_Wie gaat er kijken'), 'Wie gaat er kijken?')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_NLZIET/1ste profiel'), 0)
